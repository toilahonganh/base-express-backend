...
const { uploadSingleFile, uploadSMultipleFile } = require('../services/fileService')
...
module.exports = {
    getUsersAPI, postCreateNewUserAPI, putUpdateUserAPI, deleteUserAPI, postUploadSingleFile
};